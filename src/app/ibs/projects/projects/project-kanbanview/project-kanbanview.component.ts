...
export class ProjectKanbanviewComponent implements OnInit {
  ...
  localData: any[] = [
    ...
    { id:"kanban_table_3", collapsed:false,style:{'background-color':'rgb(189, 215, 238)'}, stage:'Design', header: 'Design (1)', data : [{ id: 'kanban_item_1166', name: 'TRPR', info: 'Updates: 6', colorCode: 'Green',percentage: '75%', campaign: 'Sandbank | Dwayne',projectcode:"6-26846 | Mearns avt", actions: 'Actions: 9/10',budget: 'Budget: $ 652/750',tasks:'Tasks: 78/100',duedate:'Due Date: 20-May-2019', hex: '#FFFFFF',}]},
    { id:"kanban_table_4", collapsed:false,style:{'background-color':'rgb(189, 215, 238)'}, stage:'Drawings', header: 'Drawings (1)', data : [{ id: 'kanban_item_1164', name: 'Survey',  info: 'Updates: 2', colorCode: 'Green',percentage: '88%', campaign: 'Valleymede | Dave',projectcode:"7-12584 | 256 Street ", actions: 'Actions: 7/10',budget: 'Budget: $ 425/650',tasks:'Tasks: 85/100',duedate:'Due Date: 18-May-2019', hex: '#FFFFFF',}]},
