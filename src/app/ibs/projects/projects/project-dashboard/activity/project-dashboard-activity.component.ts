...
@Component({
  selector: 'app-project-dashboard-activity',
  templateUrl: './project-dashboard-activity.component.html',
  styleUrls: ['./project-dashboard-activity.component.scss']
})

export class ProjectDashboardActivityComponent implements OnInit {
