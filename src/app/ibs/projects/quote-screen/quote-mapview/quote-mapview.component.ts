...
@Component({
  selector: 'app-quote-mapview',
  templateUrl: './quote-mapview.component.html',
  styleUrls: ['./quote-mapview.component.scss']
})
export class QuoteMapviewComponent implements OnInit {
