...
import { SitevisitDialogComponent } from './sitevisit-dialog/sitevisit-dialog.component';
import { MatDialog } from '@angular/material';
import { DeleteConfirmDialogComponent } from 'src/app/shared/delete-confirm-dialog/delete-confirm-dialog.component';
import { AssignteamDialogComponent } from './assignteam-dialog/assignteam-dialog.component';
...
export class SiteVisitsComponent implements OnInit {
  ...
  openAssignDialog(stat){
    let dialogRef = this.dialog.open(AssignteamDialogComponent, {
      data: stat,
      height: 'auto',
      width: '730px',
      autoFocus: false,
