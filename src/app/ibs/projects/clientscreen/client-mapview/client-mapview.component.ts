...
@Component({
  selector: 'app-client-mapview',
  templateUrl: './client-mapview.component.html',
  styleUrls: ['./client-mapview.component.scss']
})
export class ClientMapviewComponent implements OnInit {
lat:any;
lng:any;
