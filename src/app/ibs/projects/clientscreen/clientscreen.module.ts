...
import { ClientKanbanviewComponent } from './client-kanbanview/client-kanbanview.component';
...
export const routes = [
  ...
  { path: 'kanbanview', component: ClientKanbanviewComponent, data: { breadcrumb: "Kanban View" } },
];


@NgModule({
  declarations: [ClientGridviewComponent, ClientMapviewComponent,AddClientDialogComponent, ClientKanbanviewComponent],
  imports: [
