...
@Component({
  selector: 'app-assetdisposal-gridcolumns',
  templateUrl: './assetdisposal-gridcolumns.component.html',
  styleUrls: ['./assetdisposal-gridcolumns.component.scss']
})
export class AssetdisposalGridcolumnsComponent implements OnInit {
  gridColumnForm: FormGroup;
  
  constructor(public fb:FormBuilder,@Inject(MAT_DIALOG_DATA) public project: any ,public dialogRef: MatDialogRef<AssetdisposalGridcolumnsComponent>) { 
