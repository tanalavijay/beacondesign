...
@Component({
  selector: 'app-assetmaintenance-gridcolumns',
  templateUrl: './assetmaintenance-gridcolumns.component.html',
  styleUrls: ['./assetmaintenance-gridcolumns.component.scss']
})
export class AssetmaintenanceGridcolumnsComponent implements OnInit {

  gridColumnForm: FormGroup;
  
  constructor(public fb:FormBuilder,@Inject(MAT_DIALOG_DATA) public project: any ,public dialogRef: MatDialogRef<AssetmaintenanceGridcolumnsComponent>) { 
