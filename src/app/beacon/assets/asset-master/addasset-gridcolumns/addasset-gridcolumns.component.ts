...
@Component({
  selector: 'app-addasset-gridcolumns',
  templateUrl: './addasset-gridcolumns.component.html',
  styleUrls: ['./addasset-gridcolumns.component.scss']
})
export class AddassetGridcolumnsComponent implements OnInit {

  gridColumnForm: FormGroup;
  
  constructor(public fb:FormBuilder,@Inject(MAT_DIALOG_DATA) public project: any ,public dialogRef: MatDialogRef<AddassetGridcolumnsComponent>) { 
