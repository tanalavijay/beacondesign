...
@Component({
  selector: 'app-drawingdialog',
  templateUrl: './drawingdialog.component.html',
  styleUrls: ['./drawingdialog.component.scss']
})
export class DrawingdialogComponent implements OnInit {

  siteForm : FormGroup;
  constructor(public fb:FormBuilder,@Inject(MAT_DIALOG_DATA) public doc: any ,public dialogRef: MatDialogRef<DrawingdialogComponent>) { 
